...
import { ShieldCheck, MapPin, Users, Hammer, LayoutDashboard } from "lucide-react";
...
export default function HomeContent({ userRole }: { userRole?: Role }) {
  return (
        ...
        <motion.div className="w-full space-y-6" variants={STAGGER_ITEM}>
          ...
          {userRole === "ADMIN" && (
            <motion.div variants={STAGGER_ITEM}>
              <Button asChild variant="outline" size="lg" className="w-full h-14 rounded-2xl border-white/10 bg-white/5 hover:bg-white/10 text-white font-bold gap-2">
                <Link href="/admin">
